...
For test structure and coding standards, refer to [CODING_STANDARDS.md](../CODING_STANDARDS.md).

## AI Credentials

Never read the `.env` file directly. Instead, always use `#file:.env.ai` for accessing credentials for AI.
